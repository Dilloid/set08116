...
bool render() {
  ...
  for (auto &e : meshes) {
    ...
    glUniform4fv(eff.get_uniform_location("ambient_intensity"), 1,
        value_ptr(vec4(0.3f, 0.3f, 0.3f, 1.0f)));
    // Set light colour - (1.0, 1.0, 1.0, 1.0)
    glUniform4fv(eff.get_uniform_location("light_colour"), 1,
    ...
    glUniform4fv(eff.get_uniform_location("diffuse_reflection"), 1,
        value_ptr(vec4(1.0f, 0.0f, 0.0f, 1.0f)));
    // Set specular reflection - white
    glUniform4fv(eff.get_uniform_location("specular_reflection"), 1,
        value_ptr(vec4(1.0f, 1.0f, 1.0f, 1.0f)));
